var OneTrustStub = (t => {
    ...
    function u(n, a) {
        ...
        return c.next = t(0), c.throw = t(1), c.return = t(2), "function" == typeof Symbol && (c[Symbol.iterator] = function() {
            return this
        }), c;
    ...
    S.prototype.initConsentSDK = function() {
        ...
        this.isShopify = l.stubScriptElement.hasAttribute("data-shopify-consent-mapping")
        ...
        if (this.setDomainIfBulkDomainEnabled(t), this.updateVersion(t), this.subDomainEnabled = t.SubDomainEnabled || !1, this.domainHashValue = t.DomainHashValue || "", this.scriptType = t.ScriptType || "", this.ensureHtmlGroupDataInitialised(), (t.TenantFeatures && t.TenantFeatures.CookieV2CSP || t.CookieV2CSPEnabled) && this.nonce && (this.setAttributePolyfillIsActive = !0, (new h).implementThePolyfill()), A.checkAndAssignCspTrustedTypeEnabled(t) && A.initCSPTrustedType(l.storageBaseURL), !t.RuleSet[0].Type) return this.iabTypeAdded = !1, window.__tcfapi = this.executeTcfApi, this.intializeIabStub(), this.addBannerSDKScript(t);
        var e, i = window;
    ...
    }, S.prototype.otFetch = function(t, i, e, n, a) {
        ...
        a.setAttribute("src", o), this.nonce && a.setAttribute("nonce", this.nonce), a.async = !0, a.type = "text/javascript", i && n && (a.integrity = n), this.crossOrigin && a.setAttribute("crossorigin", this.crossOrigin), document.getElementsByTagName("head")[0].appendChild(a), new RegExp("^file://", "i").test(t) || l.mobileOnlineURL.push(t), e && (a.onload = a.onerror = function() {
            e()
        })
        ...
        return (this.scriptType === d || this.scriptType === p) && this.subDomainEnabled && this.domainHashValue ? "_" + this.domainHashValue : ""
        ...
        var t = "true" === this.urlParams.get("otreset"),
            ...
            i = (this.geoFromUrl = (this.urlParams.get("otgeo") || "").toLowerCase(), this.readCookieParam(c, "expiry")),
            n = this.readCookieParam(c, s);
        ...
        "debug" !== this.buildType && "cybuild" !== this.buildType || (t.Version = "202604.1.0")
    };
    var b = S;
        ...
        this.iabType = null, this.iabTypeAdded = !0, this.crossOrigin = null, this.isAmp = !1, this.domainId = "", this.isReset = !1, this.isPreview = !1, this.geoFromUrl = "", this.nonce = "", this.setAttributePolyfillIsActive = !1, this.storageBaseURL = "", this.charset = null, this.isShopify = !1, this.subDomainEnabled = !1, this.domainHashValue = "", this.scriptType = "", this.buildType = "undefined", this.addBannerSDKScript = function(s) {
            return e(r, void 0, void 0, function() {
                ...
                return u(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return ((e = this.getRegionSet(s)).GCEnable || (this.updateGtmMacros(), this.gtmUpdated = !0), this.iabTypeAdded && ("IAB2" !== e.Type && "IAB2V2" !== e.Type || (this.iabType = e.Type, this.intializeIabStub()), "IAB2" !== e.Type) && "IAB2V2" !== e.Type && this.removeTcf(), e.IsGPPEnabled ? f.init() : f.removeGppApi(), i = l.stubScriptElement.cloneNode(!0), n = "", n = s.UseSDKRefactor ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/new/scripttemplates/" + s.Version + "/" + l.bannerScriptName) : "5.11.0" === s.Version ? (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/old/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/old/scripttemplates/5.11.0/" + l.bannerScriptName) : (l.isMigratedURL && (i.src = l.storageBaseURL + "/scripttemplates/" + l.stubFileName + ".js"), l.storageBaseURL + "/scripttemplates/" + s.Version + "/" + l.bannerScriptName), ["charset", "data-language", "data-document-language", "data-domain-script", "crossorigin", "data-ignore-ga"].forEach(function(t) {
                                l.stubScriptElement.getAttribute(t) && i.setAttribute(t, l.stubScriptElement.getAttribute(t))
                            }), this.charset = l.stubScriptElement.getAttribute("charset"), this.isAmp = !!l.stubScriptElement.getAttribute("amp"), l.stubScriptElement.getAttribute("integrity")) ? (o = s.CDNLocation + "/scripttemplates/" + s.Version + "/sri-hashes.json", [4, this.fetchSriHash(o)]) : [3, 2];
                        case 1:
                            return a = t.sent(), [3, 3];
                        case 2:
                            a = null, t.label = 3;
